...
import com.wrms.vodafone.adapter.ComparisonAdapter;
 ...
 */
public class WFDataComparisonFragment extends Fragment {
   ...
   /* public static MoiostureFragment newInstance(String nextResponse) {
    ...
    public WFDataComparisonFragment(String nextResponse) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try{
            ...
            JSONArray jsonArray = jsonObject.getJSONArray("DT8");

            ArrayList<ComparisonBean> msgList = new ArrayList<ComparisonBean>();
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                bean.setMaxAct(jsonObject1.getString("MaxTemp_Act"));
                bean.setMaxFor(jsonObject1.getString("MaxTemp_For"));
                bean.setMinAct(jsonObject1.getString("MinTemp_Act"));
                bean.setMinFor(jsonObject1.getString("MinTemp_For"));
                bean.setRainAct(jsonObject1.getString("Rain_Act"));
                bean.setRainFor(jsonObject1.getString("Rain_For"));
            ...
            if (msgList.size()>0){
                ...
                ComparisonAdapter adapter = new ComparisonAdapter(getActivity(),msgList);
