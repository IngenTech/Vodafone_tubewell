...
import com.wrms.vodafone.adapter.GOAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try{
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                bean.setDate(jsonObject1.getString("DateTime"));
                bean.setMaxTemp(jsonObject1.getString("MaxTemp"));
                bean.setMinTemp(jsonObject1.getString("MinTemp"));
                bean.setHumidityMor(jsonObject1.getString("HumidityMor"));
                bean.setHumidityEve(jsonObject1.getString("HumidityEve"));
                bean.setRain(jsonObject1.getString("Rain"));
                bean.setWindSpeed(jsonObject1.getString("WindSpeed"));
                bean.setSolarRadiation(jsonObject1.getString("SolarRadiation"));
