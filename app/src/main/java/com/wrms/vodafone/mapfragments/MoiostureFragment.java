...
import com.wrms.vodafone.adapter.MoistureAdapter;
 ...
 */
public class MoiostureFragment  extends Fragment {
   ...
   /* public static MoiostureFragment newInstance(String nextResponse) {
    ...
    public MoiostureFragment(String nextResponse) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragmentContainer, fragment).addToBackStack("gro").commit();
            }
        });
