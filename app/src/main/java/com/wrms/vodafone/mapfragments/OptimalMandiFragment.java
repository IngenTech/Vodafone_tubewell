 ...
 * Use the {@link OptimalMandiFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class OptimalMandiFragment extends Fragment {
    ...
    public static OptimalMandiFragment newInstance(String param1, String param2) {
        OptimalMandiFragment fragment = new OptimalMandiFragment();
    ...
    ArrayList<OptimalMandiData> mandiArray = new ArrayList<OptimalMandiData>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        farmInfo.setText("Optimal Mandi");
    ...
    private void getCropList(final String latitude, final String longitude) {
        ...
        Log.v("optimalRequest", "http://myfarminfo.com/yfirest.svc/Mandi/Crops/" + latitude + "/" + longitude);
        ...
        StringRequest stringCropRequest = new StringRequest(Request.Method.GET, "http://myfarminfo.com/yfirest.svc/Mandi/Crops/" + latitude + "/" + longitude,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        // Display the first 500 characters of the response string.
                        System.out.println("optimal Crop Response : " + response);
                        try {
                            response = response.trim();
                    //        response = response.substring(1, response.length() - 1);
                            response = response.replace("\\", "");
...
//        /YFIRest.svc/Mandi/OptimalMandi/46/Other/25/77
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://myfarminfo.com/YFIRest.svc/Mandi/OptimalMandi/" + cropId + "/" + variety + "/" + latitude + "/" + longitude,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        // Display the first 500 characters of the response string.
                            ...
                            for (int i = 0; i < locationArray.length(); i++) {
                                ...
                                if (mMap != null) {
                                    ...
                                    if (mMarker != null) {
                                        ...
                                        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(Double.parseDouble(latitude), Double.parseDouble(longitude)), 8.0f));
    ...
    private void initializeTable(ArrayList<OptimalMandiData> data) {
