...
import com.wrms.vodafone.adapter.WMTAdapter;
 ...
 */
public class WaterManagementTech   extends Fragment {
    ...
    public WaterManagementTech(String response) {
        // Required empty public constructor
        nextResponse = response;
    }

    public WaterManagementTech() {
    ...
    public static int [] imageList={R.drawable.water_,R.drawable.water_aqua,R.drawable.water_raised};
    public static String [] nameList={"Laser Leveler","Aqua ferti Seed Drill","Raised Beds"};
    public static String [] irrigationList={"25-30%","22%","37%"};


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.water_mang_frag, container, false);
        ...
        farmInfo.setText("Water Management Technologies");
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment fragment = new MoiostureFragment(nextResponse);
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragmentContainer, fragment).addToBackStack("mos").commit();
            }
        });

        recyclerView = (ListView) view.findViewById(R.id.recyclerView_wm);
       /* LinearLayoutManager llm = new LinearLayoutManager(getActivity());
        ...
        WMTAdapter adapter = new WMTAdapter(getActivity(),nameList,irrigationList,imageList);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                          ...
                          //  response = response.substring(1, response.length() - 1);
                            ...
                            if (response!=null){
                                Fragment fragment = new MoiostureFragment(response);
                                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragmentContainer, fragment).commit();
                            }
