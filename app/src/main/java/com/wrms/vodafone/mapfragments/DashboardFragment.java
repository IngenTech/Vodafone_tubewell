...
public class DashboardFragment  extends Fragment {
    ...
    public DashboardFragment(String response) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        lat_farmer = prefs.getString("lat", null);
        lon_farmer = prefs.getString("lon", null);
...
/*
    ...
    private void getLatLongList() {
        ...
        final ProgressDialog dialoug1 = ProgressDialog.show(getActivity(), "",
                "Fetching Data Please wait...", true);

        Log.v("NDVI_Request","http://www.myfarminfo.com/yfirest.svc/Clients/WWFJalna/Data/"+farmerID+"/"+"Farm"+"/"+lat_farmer+"/"+lon_farmer);
