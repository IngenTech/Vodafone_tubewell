...
public class RegistrationData {
    ...
    public static String register(RegistrationData data) {
        ...
        try {
            ...
            response = CustomHttpClient.executeHttpPut("http://myfarminfo.com/yfirest.svc/Register/" + data.getEmailAddress() + "/" + data.getCreateUsername() + "/" + data.getPassword() + "/" + data.getVisibleNamename());
