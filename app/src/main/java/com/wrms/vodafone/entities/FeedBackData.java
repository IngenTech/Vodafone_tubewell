...
public class FeedBackData {
    ...
    public static String sentFeedBackData(FeedBackData feedBackData) {
        ...
        try {
            ...
            response = CustomHttpClient.executeHttpPut("http://myfarminfo.com/yfirest.svc/Register/" + feedBackData.getYourName() + "/" + feedBackData.getYourEmail() + "/" + feedBackData.getYourPhoneNo() + "/" + feedBackData.getYourMessage());
